...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BFH8[0x10];                                  // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_5RI6[0x138];                                 // 0x0030(0x0138) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<class FName, struct FGameplayTagSource>               TagSources;                                              // 0x0168(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_ROJW[0x80];                                  // 0x01B8(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GTVA[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YVN1[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (PADDING)
