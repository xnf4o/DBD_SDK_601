...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZYG0[0xB0];                                  // 0x0000(0x00B0) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_C8YE[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_VE1Q[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_CARH[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
