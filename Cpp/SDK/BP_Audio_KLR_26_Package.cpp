...
namespace CG
{
	...
	void UBP_Audio_KLR_25_C::IsCharacter(class ADBDPlayer* CamperPlayer, TArray<class FString>* characterName, bool* IsCharacter)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.IsCharacter");
	...
	void UBP_Audio_KLR_25_C::SelectAudioStatusStartEvent(bool IsInMenu, class UAkAudioEvent** AudioEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.SelectAudioStatusStartEvent");
	...
	void UBP_Audio_KLR_25_C::HitImpactOnSurvivorSFX(class ACamperPlayer* camper, EAttackType attackType, bool IsWeaponHit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.HitImpactOnSurvivorSFX");
	...
	void UBP_Audio_KLR_25_C::ExecuteUbergraph_BP_Audio_KLR_26(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_26.BP_Audio_KLR_25_C.ExecuteUbergraph_BP_Audio_KLR_26");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UBP_Audio_KLR_25_C.StaticClass
	...
	UClass* UBP_Audio_KLR_25_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_Audio_KLR_26.BP_Audio_KLR_25_C");
		return ptr;
	}
