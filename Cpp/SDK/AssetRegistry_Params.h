...
namespace CG
{
	...
	public:
		...
		struct FARFilter                                           ReturnValue;                                             // 0x0000(0x00F0)  (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		struct FAssetData                                          InAssetData;                                             // 0x0000(0x0078)  (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		class FName                                                InTagName;                                               // 0x0000(0x000C)  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	public:
		...
		struct FAssetData                                          ReturnValue;                                             // 0x0000(0x0078)  (Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
