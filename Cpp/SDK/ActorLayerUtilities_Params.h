...
namespace CG
{
	...
	public:
		...
		struct FActorLayer                                         Layer;                                                   // 0x0000(0x000C)  (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		struct FActorLayer                                         ActorLayer;                                              // 0x0000(0x000C)  (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
