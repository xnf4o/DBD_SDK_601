...
namespace CG
{
	...
	void UBP_Audio_KLR_14_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_15.BP_Audio_KLR_14_C.ReceiveBeginPlay");
	...
	void UBP_Audio_KLR_14_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_15.BP_Audio_KLR_14_C.ReceiveEndPlay");
	...
	void UBP_Audio_KLR_14_C::ExecuteUbergraph_BP_Audio_KLR_15(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_15.BP_Audio_KLR_14_C.ExecuteUbergraph_BP_Audio_KLR_15");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UBP_Audio_KLR_14_C.StaticClass
	...
	UClass* UBP_Audio_KLR_14_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_Audio_KLR_15.BP_Audio_KLR_14_C");
		return ptr;
	}
