...
namespace CG
{
	...
	void UBP_Audio_KLR_18_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_19.BP_Audio_KLR_18_C.ReceiveBeginPlay");
	...
	void UBP_Audio_KLR_18_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_19.BP_Audio_KLR_18_C.ReceiveEndPlay");
	...
	void UBP_Audio_KLR_18_C::ExecuteUbergraph_BP_Audio_KLR_19(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_19.BP_Audio_KLR_18_C.ExecuteUbergraph_BP_Audio_KLR_19");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UBP_Audio_KLR_18_C.StaticClass
	...
	UClass* UBP_Audio_KLR_18_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_Audio_KLR_19.BP_Audio_KLR_18_C");
		return ptr;
	}
