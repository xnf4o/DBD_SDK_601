...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PY0X[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_W2RV[0x3];                                   // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_GMEG[0x3];                                   // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_G3G5[0x3];                                   // 0x0010(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_56EP[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_OF1Y[0x3];                                   // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_G1RZ[0x3];                                   // 0x004C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	public:
		...
		unsigned char                                              UnknownData_OB1F[0x3];                                   // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		int32_t                                                    KeyPortIdentifier;                                       // 0x0048(0x0004) Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	};
