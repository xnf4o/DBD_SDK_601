...
namespace CG
{
	...
	bool USkillCheckProbabilityProficiency_C::GetIsActive(class UChargeableInteractionDefinition* chargeableInteraction, class ADBDPlayer* Player)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SkillCheckProbabilityProficiency.SkillCheckProbabilityProficiency_C.GetIsActive");
	...
	EStatusEffectType USkillCheckProbabilityProficiency_C::GetType(float value)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SkillCheckProbabilityProficiency.SkillCheckProbabilityProficiency_C.GetType");
	...
	float USkillCheckProbabilityProficiency_C::GetValue(class UChargeableInteractionDefinition* chargeableInteraction, class ADBDPlayer* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SkillCheckProbabilityProficiency.SkillCheckProbabilityProficiency_C.GetValue");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction USkillCheckProbabilityProficiency_C.StaticClass
	...
	UClass* USkillCheckProbabilityProficiency_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass SkillCheckProbabilityProficiency.SkillCheckProbabilityProficiency_C");
		return ptr;
	}
