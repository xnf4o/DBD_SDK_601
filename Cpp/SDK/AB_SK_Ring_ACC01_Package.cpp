...
namespace CG
{
	...
	void UAB_SK_Ring_ACC01_C::AnimGraph(struct FPoseLink* AnimGraph)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_SK_Ring_ACC01.AB_SK_Ring_ACC01_C.AnimGraph");
	...
	void UAB_SK_Ring_ACC01_C::BlueprintUpdateAnimation(float DeltaTimeX)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_SK_Ring_ACC01.AB_SK_Ring_ACC01_C.BlueprintUpdateAnimation");
	...
	void UAB_SK_Ring_ACC01_C::ExecuteUbergraph_AB_SK_Ring_ACC01(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_SK_Ring_ACC01.AB_SK_Ring_ACC01_C.ExecuteUbergraph_AB_SK_Ring_ACC01");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UAB_SK_Ring_ACC01_C.StaticClass
	...
	UClass* UAB_SK_Ring_ACC01_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_SK_Ring_ACC01.AB_SK_Ring_ACC01_C");
		return ptr;
	}
