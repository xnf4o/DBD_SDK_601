...
namespace CG
{
	...
	void ABP_Menu_CamperMale12_C::ExecuteUbergraph_BP_Menu_CamperMale12(int32_t EntryPoint)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Menu_CamperMale12.BP_Menu_CamperMale12_C.ExecuteUbergraph_BP_Menu_CamperMale12");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction ABP_Menu_CamperMale12_C.StaticClass
	...
	UClass* ABP_Menu_CamperMale12_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_Menu_CamperMale12.BP_Menu_CamperMale12_C");
		return ptr;
	}
