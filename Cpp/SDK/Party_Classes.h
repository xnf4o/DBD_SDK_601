...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YEXR[0x18];                                  // 0x0048(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MV3Z[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VQCC[0x140];                                 // 0x0070(0x0140) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AU67[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RIFF[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GAA4[0x7F];                                  // 0x0121(0x007F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XLT4[0x10];                                  // 0x01A8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OTPJ[0x110];                                 // 0x01C0(0x0110) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WP9I[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_99D4[0x80];                                  // 0x0078(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_BK66[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QF9F[0x50];                                  // 0x0088(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LB0Q[0x118];                                 // 0x00E8(0x0118) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VUFJ[0x50];                                  // 0x0030(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VGJF[0x7];                                   // 0x0171(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*>  GroupChannels;                                           // 0x0178(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_NZ6N[0x60];                                  // 0x01C8(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FDNM[0xC0];                                  // 0x0030(0x00C0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0XMD[0x10];                                  // 0x00F0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_474B[0x60];                                  // 0x0030(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MGW9[0x10];                                  // 0x0088(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WN1W[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_CMVH[0x140];                                 // 0x0030(0x0140) MISSED OFFSET (PADDING)
