...
namespace CG
{
	...
	void UBP_Audio_KLR_26_C::IsCharacter(class ADBDPlayer* CamperPlayer, TArray<class FString>* characterName, bool* IsCharacter)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_27.BP_Audio_KLR_26_C.IsCharacter");
	...
	void UBP_Audio_KLR_26_C::SelectAudioStatusStartEvent(bool IsInMenu, class UAkAudioEvent** AudioEvent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_27.BP_Audio_KLR_26_C.SelectAudioStatusStartEvent");
	...
	void UBP_Audio_KLR_26_C::HitImpactOnSurvivorSFX(class ACamperPlayer* camper, EAttackType attackType, bool IsWeaponHit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_27.BP_Audio_KLR_26_C.HitImpactOnSurvivorSFX");
	...
	void UBP_Audio_KLR_26_C::ExecuteUbergraph_BP_Audio_KLR_27(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_Audio_KLR_27.BP_Audio_KLR_26_C.ExecuteUbergraph_BP_Audio_KLR_27");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UBP_Audio_KLR_26_C.StaticClass
	...
	UClass* UBP_Audio_KLR_26_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_Audio_KLR_27.BP_Audio_KLR_26_C");
		return ptr;
	}
