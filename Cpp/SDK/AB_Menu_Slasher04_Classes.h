...
namespace CG
{
	...
	public:
		...
		struct FAnimNode_SequencePlayer                            AnimGraphNode_SequencePlayer;                            // 0x0408(0x0080)
		struct FAnimNode_BlendListByBool                           AnimGraphNode_BlendListByBool_2;                         // 0x0488(0x00A0)
