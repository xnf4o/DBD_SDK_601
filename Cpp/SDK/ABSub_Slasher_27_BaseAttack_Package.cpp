...
namespace CG
{
	...
	void UABSub_Slasher_27_BaseAttack_C::BlueprintInitializeAnimation()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABSub_Slasher_27_BaseAttack.ABSub_Slasher_27_BaseAttack_C.BlueprintInitializeAnimation");
	...
	void UABSub_Slasher_27_BaseAttack_C::ExecuteUbergraph_ABSub_Slasher_27_BaseAttack(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ABSub_Slasher_27_BaseAttack.ABSub_Slasher_27_BaseAttack_C.ExecuteUbergraph_ABSub_Slasher_27_BaseAttack");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UABSub_Slasher_27_BaseAttack_C.StaticClass
	...
	UClass* UABSub_Slasher_27_BaseAttack_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("AnimBlueprintGeneratedClass ABSub_Slasher_27_BaseAttack.ABSub_Slasher_27_BaseAttack_C");
		return ptr;
	}
