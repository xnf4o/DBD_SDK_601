...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TV8V[0x3];                                   // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z0N6[0x4];                                   // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XKGU[0x10];                                  // 0x00C8(0x0010) MISSED OFFSET (PADDING)
