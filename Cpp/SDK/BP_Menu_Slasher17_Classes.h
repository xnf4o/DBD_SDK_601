...
namespace CG
{
	...
	{
	public:
		class UBP_Audio_KLR_17_C*                                  BP_Audio_KLR_18;                                         // 0x06B8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
