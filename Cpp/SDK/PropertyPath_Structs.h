...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YJQK[0x10];                                  // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8YJI[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ANUN[0x8];                                   // 0x0020(0x0008) MISSED OFFSET (PADDING)
	};
