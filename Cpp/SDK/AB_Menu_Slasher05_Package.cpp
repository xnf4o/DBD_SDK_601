...
namespace CG
{
	...
	void UAB_Menu_Slasher05_C::AnimGraph(struct FPoseLink* AnimGraph)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_Menu_Slasher05.AB_Menu_Slasher05_C.AnimGraph");
	...
	void UAB_Menu_Slasher05_C::BlueprintUpdateAnimation(float DeltaTimeX)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_Menu_Slasher05.AB_Menu_Slasher05_C.BlueprintUpdateAnimation");
	...
	void UAB_Menu_Slasher05_C::ExecuteUbergraph_AB_Menu_Slasher05(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AB_Menu_Slasher05.AB_Menu_Slasher05_C.ExecuteUbergraph_AB_Menu_Slasher05");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefindFunction UAB_Menu_Slasher05_C.StaticClass
	...
	UClass* UAB_Menu_Slasher05_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("AnimBlueprintGeneratedClass AB_Menu_Slasher05.AB_Menu_Slasher05_C");
		return ptr;
	}
